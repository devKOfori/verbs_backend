...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('e99b0aab-ec63-46b3-a82a-f448537216da'), primary_key=True, serialize=False)),
                ('name', models.CharField(db_index=True, max_length=255, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='OrderStatus',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('11e129f0-6c12-4b97-aff9-1e65c840279e'), primary_key=True, serialize=False)),
                ('name', models.CharField(db_index=True, max_length=255, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'New'), ('used', 'Used'), ('expired', 'Expired')], default='new', max_length=7)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dimension', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='api.dimension')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_dimensions', to='api.product')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', models.DecimalField(decimal_places=2, default=0.0, max_digits=6)),
                ('qty', models.PositiveIntegerField(default=1)),
                ('color', models.ForeignKey(default=helpers.defaults.product_color_default, on_delete=django.db.models.deletion.SET_DEFAULT, to='api.color')),
                ('dimension', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.dimension')),
                ('frame_type', models.ForeignKey(default=helpers.defaults.product_frame_type_default, on_delete=django.db.models.deletion.SET_DEFAULT, to='api.frametype')),
